...
const SignupTourCompany = ({navigation}) => {
return (
...
<ScrollView showsVerticalScrollIndicator={false}>  
      ...
      <View style={styles.headerText}>
         ...
         <Text  style={styles.headerTextStyle2} > (Tour Company)</Text>
         <Text style={styles.headerTextdes}>Please fill all the required information and submit your profile.
           ...
           {/* TourCompany Guide form  starts here*/}
       <View style={styles.inputsContainer}>
          ...
          <View style={{flexDirection:'row' , alignItems:"center"}}>
           ...
           {/* TourCompany Guide form  ends  here*/}
...
export default SignupTourCompany;